...
for($loop2=0;$loop2!=$loop;$loop2++) {
    ...
    echo "<p  style='background:#eee;margin-top:0px;padding:10px'>".$subjects_array['title'][$loop2]."</p>";
    echo "<a href='list_of_guides?subject=".$subjects_array['id'][$loop2]."'><button class='btn btn-block' style='background:#29d846;color:#fff'>לצפיה במדריכים</button></a></div>";
